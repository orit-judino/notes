...
ОД_дизартрия_03: 0
spastika_pwr: 1
result: "I69.3 ЦВБ. Последствия инфаркта головного мозга от 08.01.2026 в левой СМА, тип по TOAST: **Подтип инсульта**: `INPUT[inlineSelect(option(атеротромботический), option(кардиоэмболический), option(неустановленный), option(лакунарный)): ОД_инсульт_подтип]`. Гемипарез: глубокий парез - 1 б. справа, афазия: моторная, умеренная, спастичность: умеренная, нейрогенный мочевой пузырь: умеренные нарушения."
ОД_дата: 2026-01-08
ОД_спастика_03: 1
...
ОД_инсульт_подтип_test: "**Подтип инсульта**: `INPUT[inlineSelect(option(атеротромботический), option(кардиоэмболический), option(неустановленный), option(лакунарный)):ОД_инсульт_подтип]`"
ОД_инсульт_подтип: "**Подтип инсульта**:`INPUT[inlineSelect(option(атеротромботический), option(кардиоэмболический), option(неустановленный), option(лакунарный)):ОД_инсульт_подтип]`"
---
## Скрипты
```meta-bind-button
