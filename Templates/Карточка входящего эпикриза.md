...
ОД_мкб: "[[Справочники/Заболевания/Основные заболевания/Основные заболевания.md|Основные заболевания]]"
ОД_бассейн: СМА
ОД_парезРука_05: 1
ОД_парезНога_05: 1
ОД_нгз: false
...
ОД_инсульт_подтип: "**Подтип инсульта**:`INPUT[inlineSelect(option(нет frontmatter)):ОД_инсульт_подтип]`"
ОД_нейропузырь_03: 1
ОД_фолей: false
